...
export const keyMap: KeyMap = {
  ...
  notes: {
    ...
    'C#4': { key: 'f1', octave: 1 }, // Df4
    D4: { key: '2', octave: 1 },
    'D#4': { key: 'f2', octave: 1 }, // Ef4
    E4: { key: '3', octave: 1 },
    F4: { key: '4', octave: 1 },
    'F#4': { key: 'f3', octave: 1 }, // Gf4
    G4: { key: '5', octave: 1 },
    'G#4': { key: 'f4', octave: 1 }, // Af4
    A4: { key: '6', octave: 1 },
    'A#4': { key: 'f5', octave: 1 }, // Bf4
    B4: { key: '7', octave: 1 },

    C5: { key: '8', octave: 1, altOctave: 2, altOctaveKey: '1' },
    'C#5': { key: 'f1', octave: 2 }, // Df5
    D5: { key: '2', octave: 2 },
    'D#5': { key: 'f2', octave: 2 }, // Ef5
    E5: { key: '3', octave: 2 },
    F5: { key: '4', octave: 2 },
    'F#5': { key: 'f3', octave: 2 }, // Gf5
    G5: { key: '5', octave: 2 },
    'G#5': { key: 'f4', octave: 2 }, // Af5
    A5: { key: '6', octave: 2 },
    'A#5': { key: 'f5', octave: 2 }, // Bf5
    B5: { key: '7', octave: 2 },
    C6: { key: '8', octave: 2 }
